...
Originally from issue [#787](https://github.com/circl-dev/go-swagger/issues/787).
...
import (
    loads "github.com/circl-dev/loads"
...
Originally from issue [#719](https://github.com/circl-dev/go-swagger/issues/719).
