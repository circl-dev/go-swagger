# Swagger 2.0 [![Build Status](https://circleci.com/gh/circl-dev/go-swagger.svg?style=shield)](https://circleci.com/gh/circl-dev/go-swagger) [![Build status](https://ci.appveyor.com/api/projects/status/x377t5o9ennm847o/branch/master?svg=true)](https://ci.appveyor.com/project/casualjim/go-swagger/branch/master) [![codecov](https://codecov.io/gh/circl-dev/go-swagger/branch/master/graph/badge.svg)](https://codecov.io/gh/circl-dev/go-swagger) [![GitHub version](https://badge.fury.io/gh/go-swagger%2Fgo-swagger.svg)](https://badge.fury.io/gh/go-swagger%2Fgo-swagger)
...
[![GoDoc](https://godoc.org/github.com/circl-dev/go-swagger?status.svg)](http://godoc.org/github.com/circl-dev/go-swagger)
...
[![GolangCI](https://golangci.com/badges/github.com/circl-dev/go-swagger.svg)](https://golangci.com)
[![Go Report Card](https://goreportcard.com/badge/github.com/circl-dev/go-swagger)](https://goreportcard.com/report/github.com/circl-dev/go-swagger)
...
> ![swagger](https://raw.githubusercontent.com/circl-dev/go-swagger/master/docs/favicon-16x16.png) **Swagger in a nutshell**
>
...
- A jsonschema (Draft 4) validator, with full $ref support: [validate](https://github.com/circl-dev/validate)
...
## Use-cases
The main package of the toolkit, circl-dev/go-swagger, provides command line tools to help working with swagger.
...
To generate a [CLI for a swagger spec](https://github.com/circl-dev/go-swagger/tree/master/examples/cli) document:
```
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io#https://github.com/circl-dev/go-swagger)
...
```
github.com/circl-dev/go-swagger/httpkit/validate to github.com/circl-dev/validate
github.com/circl-dev/go-swagger/httpkit to github.com/circl-dev/runtime
github.com/naoina/denco to github.com/circl-dev/runtime/middleware/denco
github.com/circl-dev/go-swagger to github.com/go-openapi
```
