...
func main() {
	req, err := http.NewRequest("GET", "https://api.github.com/repos/circl-dev/go-swagger/releases", nil)
	// req, err := http.NewRequest("GET", "https://api.github.com/repos/circl-dev/go-swagger/releases/latest", nil)
	if err != nil {
		log.Fatalln(err)
	}
