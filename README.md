...
- A jsonschema (Draft 4) validator, with full $ref support: [validate](https://github.com/go-swagger/validate)
...
```
github.com/go-swagger/go-swagger/httpkit/validate to github.com/go-swagger/validate
github.com/go-swagger/go-swagger/httpkit to github.com/go-swagger/runtime
github.com/naoina/denco to github.com/go-swagger/runtime/middleware/denco
