...
func TestTemplates_DefinitionTargetImportPath(t *testing.T) {
	...
	var expected = "github.com/protodev-site/go-swagger/fixtures"
...
func TestTemplates_FuncMap(t *testing.T) {
	...
	assert.Contains(t, rendered.String(), `Json={"errors":"github.com/go-openapi/errors","runtime":"github.com/protodev-site/runtime","swag":"github.com/go-openapi/swag","validate":"github.com/protodev-site/validate"}`)
	assert.Contains(t, rendered.String(), "\"TargetImportPath\": \"github.com/protodev-site/go-swagger/generator\"")
