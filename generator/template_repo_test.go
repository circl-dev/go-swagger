...
func TestTemplates_DefinitionTargetImportPath(t *testing.T) {
	...
	var expected = "github.com/circl-dev/go-swagger/fixtures"
...
func TestTemplates_FuncMap(t *testing.T) {
	...
	assert.Contains(t, rendered.String(), `Json={"errors":"github.com/go-openapi/errors","runtime":"github.com/circl-dev/runtime","swag":"github.com/go-openapi/swag","validate":"github.com/circl-dev/validate"}`)
	assert.Contains(t, rendered.String(), "\"TargetImportPath\": \"github.com/circl-dev/go-swagger/generator\"")
