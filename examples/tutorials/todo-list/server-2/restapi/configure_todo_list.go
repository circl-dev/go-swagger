...
import (
	...
	"github.com/circl-dev/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/circl-dev/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
