...
import (
	...
	"github.com/circl-dev/go-swagger/examples/auto-configure/implementation"
...
//go:generate swagger generate server --target ../../auto-configure --name AToDoListApplication --spec ../swagger.yml --implementation-package github.com/circl-dev/go-swagger/examples/auto-configure/implementation --principal interface{}
