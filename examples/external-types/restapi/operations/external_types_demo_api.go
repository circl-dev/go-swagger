...
func (o *ExternalTypesDemoAPI) Validate() error {
	...
	if o.GetStreamHandler == nil {
		unregistered = append(unregistered, "GetStreamHandler")
	}
	...
	if o.PutTestHandler == nil {
		unregistered = append(unregistered, "PutTestHandler")
	}
...
func (o *ExternalTypesDemoAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/stream"] = NewGetStream(o.context, o.GetStreamHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["PUT"]["/test"] = NewPutTest(o.context, o.PutTestHandler)
}

// Serve creates a http handler to serve the API over HTTP
// can be used directly in http.ListenAndServe(":8000", api.Serve(nil))
func (o *ExternalTypesDemoAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
