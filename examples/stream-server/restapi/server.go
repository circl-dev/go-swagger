...
// NewServer creates a new api countdown server but does not configure it
...
type Server struct {
	...
	SocketPath    flags.Filename `long:"socket-path" description:"the unix socket to listen on" default:"/var/run/countdown.sock"`
...
func (s *Server) SetAPI(api *operations.CountdownAPI) {
	if api == nil {
		s.api = nil
		s.handler = nil
		return
