...
// NewHTTPClientWithConfig creates a new a to do list application HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *AToDoListApplication {
